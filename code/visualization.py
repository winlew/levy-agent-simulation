...
def extract_high_resolution_frame(folder, frame, iteration):
    ...
    legend = ax.legend(handles=legend_elements, handlelength=0.8, loc='lower left', ncols=2, fontsize=8, fancybox=True, edgecolor='gray', borderpad=0.5, facecolor='white', frameon=True, framealpha=1, handletextpad=0.5)
